...
<SYNTAX PUT OBJECT (MANY TAKE HELD CARRIED) IN OBJECT (FIND CONTBIT) = V-PUT-IN
        PRE-PUT-IN>
...
<SYNTAX TAKE OBJECT (MANY IN-ROOM) FROM OBJECT (FIND CONTBIT) = V-TAKE-FROM PRE-TAKE-FROM>
