...
;<VERSION XZIP>	;"version is set externally"
...
<ROUTINE GO ()
    ...
    <REPEAT ()
        ...
        ;<DUMPBUF>
        ;<DUMPLEX>
        ;<TELL "D.O. is " D ,PRSO " and I.O. is " D ,PRSI CR>
        <COND (<AND ,DTURNS> <TELL "Turn # " N ,TURNS CR>)>
        ;<CRLF>
    >
>
...
<ROUTINE C-SIGN-R ()
       <COND (<VERB? EXAMINE> <TELL <PICK-ONE ,SIGN-DESCRIPS> CR> )
             (<VERB? READ> <TELL "The signature at the bottom rearranges itself to read " <PICK-ONE-R ,SIGN-READS> CR> )
       >>
...
<ROUTINE DARKNESS-R ()
    <COND (<VERB? THINK-ABOUT> <TELL "Light, darkness. Your favorite cloak has something to do with them, yes?" CR>)>>
