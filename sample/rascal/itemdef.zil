...
<CONSTANT ITEMKIND-COFFER 9>
<CONSTANT ITEMKIND-ALTAR 10>
<CONSTANT ITEMKIND-COUNT 10>

<CONSTANT COFFER-TYPE-COFFER 1>
<CONSTANT COFFER-TYPE-MIMICK 2>
...
<CONSTANT POTION-TORPOR 9>
<CONSTANT POTION-HUSTLE 10>
<CONSTANT POTION-RAGING 11>
<CONSTANT POTION-ARMOUR 12>
<CONSTANT POTION-VIGOUR 13>
<CONSTANT POTION-EXCESS 14>
<CONSTANT POTION-ALLURE 15>
<CONSTANT POTION-SCHEMA 16>
<CONSTANT POTION-ACUMEN 17>
<CONSTANT POTION-TYPE-COUNT 17>
...
<CONSTANT POTCOLOR-AUBURN 9>
<CONSTANT POTCOLOR-SIENNA 10>
<CONSTANT POTION-COLOR-COUNT 10>

<CONSTANT ALTAR-CATEGORY-NONE 0>
<CONSTANT ALTAR-CATEGORY-COMBAT 1>
<CONSTANT ALTAR-CATEGORY-HEALTH 2>
<CONSTANT ALTAR-CATEGORY-WEALTH 3>
<CONSTANT ALTAR-CATEGORY-WISDOM 4>
...
<ROUTINE PRINT-POTION-EFFECT-NAME (TYPE)
    <COND (<==? .TYPE ,POTION-MUSCLE> <TELL "muscle">)
      ...
      (<==? .TYPE ,POTION-TORPOR> <TELL "torpor">)
      (<==? .TYPE ,POTION-HUSTLE> <TELL "hustle">)
          (<==? .TYPE ,POTION-RAGING> <TELL "raging">)
          (<==? .TYPE ,POTION-ARMOUR> <TELL "armour">)
          (<==? .TYPE ,POTION-VIGOUR> <TELL "vigour">)
          (<==? .TYPE ,POTION-EXCESS> <TELL "excess">)
          (<==? .TYPE ,POTION-ALLURE> <TELL "allure">)
          (<==? .TYPE ,POTION-SCHEMA> <TELL "schema">)
          (<==? .TYPE ,POTION-ACUMEN> <TELL "acumen">)
          (ELSE <TELL "potion">)>
    <RTRUE>>
...
<ROUTINE PRINT-POTION-COLOR-ADJ (COLOR)
    <COND (<==? .COLOR ,POTCOLOR-ARGENT> <TELL "argent">)
      ...
      (<==? .COLOR ,POTCOLOR-AUBURN> <TELL "auburn">)
      (<==? .COLOR ,POTCOLOR-SIENNA> <TELL "sienna">)
          (ELSE <TELL "colored">)>
    <RTRUE>>
...
<ROUTINE PRINT-POTION-DISPLAY-NAME (COLOR "AUX" TYPE)
    <COND (<OR <L? .COLOR 1> <G? .COLOR ,POTION-TYPE-COUNT>>
           <TELL "potion">
           <RTRUE>)>
    ;"Fixed potions (ITID > POTION-COLOR-COUNT) always show their type name."
    <COND (<G? .COLOR ,POTION-COLOR-COUNT>
           <PRINT-POTION-TYPE-NAME .COLOR>
           <RTRUE>)>
...
<ROUTINE POTION-ARTICLE (COLOR)
    ;"Fixed potions always start with 'a' (a potion of ...)."
    <COND (<G? .COLOR ,POTION-COLOR-COUNT> <RETURN "a">)>
