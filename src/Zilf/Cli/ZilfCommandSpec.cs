...
namespace Zilf.Cli
{
    internal sealed record class ZilfCommandSpec(
        ...
        Option<bool> BuildOptimizationLevel0Option,
        Option<bool> BuildOptimizationLevel1Option,
        Option<bool> BuildOptimizationLevel2Option,
        Option<bool> BuildOptimizationLevel3Option,
        Option<bool> BuildOptimizeForSizeOption,
